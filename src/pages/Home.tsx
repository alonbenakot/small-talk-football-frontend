      ...
      >
        ...
        >
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-slate-300 mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed">
            ...
            We'll teach you everything you need to know to impress your co-workers, loved ones, and even random people
            in the elevator!
          </p>
          <Link to={"/matches"}>
            <Button buttonType="prominent">
              Get Started
            </Button>
          </Link>
        </motion.section>
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-300 text-lg">
                    ...
                    feature, you'll get quick summaries and conversation starters. For example, if Manchester City had a
                    goal disallowed for{" "}
                    {offsideCard && (
                        <Link to={`/cheat-cards/${offsideCard.id}`}
              ...
              <div className="space-y-6 text-slate-300 text-lg leading-relaxed">
                <p>
                  ...
                  {pickATeamArticle && (
                      <>
                        {" "}Check out{" "}
                        <Link to={`/articles/${pickATeamArticle.id}`}
                              className="text-emerald-400 hover:underline font-medium">
                ...
                {partnerArticle && (
                    <p className="pt-4 border-t border-slate-600">
                      <span className="font-semibold text-slate-100">Bonus:</span> Want to share your newfound
                      knowledge? Read{" "}
                      <Link to={`/articles/${partnerArticle.id}`}
                            className="text-emerald-400 hover:underline font-medium">
